...
REGISTRATION_TERMINOLOGY = {
    ...
    "course_delivery_types": {
        "In-person section (Campus presence)": "In-person section; not for online students. The class is held in a classroom at a scheduled time. Course time and location are available in Carleton Central.",
        "Mix of In-person and Online (Campus presence)": "In-person and online classes/activities. In-person activities may include meetings, in-term assessment and/or the final exam. Online activities may include live classes at the scheduled time and/or previously recorded lectures. More details are available in the course outline. Computer requirements: high-speed Internet access, webcam, and headset with a microphone.",
        "Online Scheduled Section (Campus presence is not required)": "Online classes/activities at a scheduled time. Usually, live classes/activities run every week. If not, specific dates are available in the course outline. Computer requirements: high-speed Internet access, webcam, and headset with a microphone.",
        "Online Scheduled Section with In-Person Assessments (Campus presence)": "Online classes/activities at a scheduled time. Usually, live classes/activities run every week. If not, specific dates are available in the course outline. Assessments (in-term, final, or both) are in-person and on campus. Computer requirements: high-speed Internet access, webcam, and headset with a microphone.",
        "Online Unscheduled Section (Campus presence is not required)": "Online classes/activities are not scheduled. Students are expected to remain up to date with deadlines and due dates provided by the instructor. Computer requirements: high-speed Internet access and a computer.",
        "Online Unscheduled Section with In-Person Assessments (Campus presence)": "Online classes/activities are not scheduled. Assessments (in-term, final, or both) are in-person and on campus. Computer requirements: high-speed Internet access, webcam, and headset with a microphone.",
        "In-person section (Optional campus presence)": "In-person section; students may choose to attend classes in-person OR online on a class-by-class basis. In-term and final assessments may be in-person or online. Distance students should contact the department to find out if they should register in the course. The class is held in a classroom at a scheduled time. Time and location are available in Carleton Central.",
    },
}
